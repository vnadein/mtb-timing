...
* При запросе 1 раз в секунду = 372 суток
* При запросе 10 раз в секунду = 93 суток
* При запросе 20 раз в секунду = 18 суток
...
# Line заметки
* необходима библиотека pybluez, отлично ставится через пип. Однако предварительно нужно установить в систему пакет
